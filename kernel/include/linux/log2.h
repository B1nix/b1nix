 ...
 *
 * It exists separately from ilog2 because the ordinary one uses a builtin that
 * is not a constant expression to the C front end, and these are used to size
 * arrays and inside static_assert. Written as the recursive conditional
 * upstream uses, which the compiler folds.
 */
#ifndef const_ilog2
