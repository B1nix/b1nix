...
/* Copied from Linux 6.18.51 (cleanup.h: typeof spelled __typeof__ for the
 * strict-C11 units); warnings inside it are upstream's. */
...
#define no_free_ptr(p) \
	((__typeof__(p)) __must_check_fn((__force const volatile void *)__get_and_null(p, NULL)))
