...
static inline void refcount_inc(refcount_t *r) { __atomic_fetch_add(&r->refs.counter, 1, __ATOMIC_RELAXED); }
...
static inline void refcount_dec(refcount_t *r) { __atomic_fetch_sub(&r->refs.counter, 1, __ATOMIC_RELAXED); }
