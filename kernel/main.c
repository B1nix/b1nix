...
/* Generated by the driver's own module_init() — see <linux/module.h>. */
extern int lkpi_initcall_i915_init(void);
static void i915_module_init(void) { (void)lkpi_initcall_i915_init(); }
#endif
...
void kernel_main(usize arg0, usize arg1)
{
	...
	/* M102a: the boot CPU's family/model, read once before any driver probes —
	 * a quirk keyed on model must not match a zeroed struct. */
	lkpi_cpuinfo_init();
