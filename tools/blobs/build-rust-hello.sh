#!/bin/sh
# build-rust-hello.sh — regenerate tools/blobs/hello_b1nix.elf (M67 Rust port smoke).
#
# Compiles tools/blobs/hello_b1nix.rs for x86_64-unknown-b1nix with nightly rustc
...
# as tools/blobs/linux_hello.bin). Run this by hand after changing the source or
...
sh "$ROOT/tools/ports/build-rust.sh" "$PROJ"
