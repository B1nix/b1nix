...
LIBM_DIR="$($ROOT_DIR/tools/build-openlibm.sh)"
PIXMAN_DIR="$(B1NIX_ARCH="$B1NIX_ARCH" "$ROOT_DIR/tools/build-pixman.sh")"
FT_DIR="$(B1NIX_ARCH="$B1NIX_ARCH" "$ROOT_DIR/tools/build-freetype.sh")"
