...
#
#   tools/toolchain/copy-if-changed.sh SRC... DEST         # DEST is a file or a directory
#   tools/toolchain/copy-if-changed.sh -r SRC... DESTDIR   # directories, copied recursively
#   tools/toolchain/copy-if-changed.sh --into DIR SRC...   # DIR/<relative path of SRC>,
