...
#
# Exceptions live in tools/toolchain/static-allowlist.txt, one path per line with
...
#
# Usage: sh tools/toolchain/check-dynamic.sh [rootfs-dir]
...
ALLOWLIST="$PROJECT_DIR/tools/toolchain/static-allowlist.txt"
