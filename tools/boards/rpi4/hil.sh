...
# ==============================================================================
# Usage:
#   sh tools/boards/rpi4/hil.sh [run|setup|deploy|uart] [options]
#
# Options:
#   --config, -c <file>      Configuration file (default: tools/boards/rpi4/hil.conf)
...
CONFIG_FILE="$PROJECT_DIR/tools/boards/rpi4/hil.conf"
...
CONFIG_EOF
    ...
    # DTB
    if [ -f "$PROJECT_DIR/tools/boards/dts/bcm2711-rpi-4-b.dtb" ]; then
        cp -f "$PROJECT_DIR/tools/boards/dts/bcm2711-rpi-4-b.dtb" "$TFTP_ROOT/bcm2711-rpi-4-b.dtb"
