...
# signatures:
# every package's sha256 is recorded in tools/image/alpine/alpine.lock and checked on
...
#
# Usage:
#   tools/image/alpine/alpine-fetch.sh <prefix> <package>...
#   ALPINE_LOCK_UPDATE=1 tools/image/alpine/alpine-fetch.sh ...   # record new hashes
#
# Environment:
