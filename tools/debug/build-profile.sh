#!/bin/sh
# tools/debug/build-profile.sh - time each phase of the smoke-suite build.
#
...
#
#   sh tools/debug/build-profile.sh            # profile an incremental build
#   PROFILE_LABEL=after sh tools/debug/build-profile.sh
#
