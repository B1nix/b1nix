 ...
 * Enhanced for b1nix RP2350 HIL Test Controller
 */
...
static const char *const usbd_desc_str[] = {
	[USBD_STR_MANUF] = "b1nix Project",
	[USBD_STR_PRODUCT] = "RP2350 HIL UART Bridge",
	[USBD_STR_SERIAL] = usbd_serial,
	[USBD_STR_CDC_0] = "b1nix Primary UART0 (Console)",
	[USBD_STR_CDC_1] = "b1nix Secondary UART1 (Aux)",
};
