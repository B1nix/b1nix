#!/bin/sh
# tools/build/copy-if-changed.sh - copy files into the staging rootfs, but only the
...
#
#   tools/build/copy-if-changed.sh SRC... DEST         # DEST is a file or a directory
#   tools/build/copy-if-changed.sh -r SRC... DESTDIR   # directories, copied recursively
#   tools/build/copy-if-changed.sh --into DIR SRC...   # DIR/<relative path of SRC>,
