...
# xxd is a vim binary and a host without vim has none; tools/build/xxd-i.sh produces
...
mkdir -p "$(dirname "$OUT")"
: > "$OUT"
printf '/* Generated by tools/build/kernel/gen_modules_initramfs.sh — do not edit. */\n' >> "$OUT"
for ko in "$@"; do
    name="$(basename "$ko" .ko)"
