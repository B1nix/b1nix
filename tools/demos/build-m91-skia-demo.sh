...
FONTCONFIG_A="$ROOT_DIR/build/$B1NIX_ARCH/pkg/fontconfig/lib/libfontconfig.a"
FREETYPE_A="$ROOT_DIR/build/$B1NIX_ARCH/pkg/freetype/lib/libfreetype.a"
ZLIB_A="$ROOT_DIR/build/$B1NIX_ARCH/pkg/zlib/lib/libz.a"
EXPAT_A="$ROOT_DIR/build/$B1NIX_ARCH/pkg/expat/lib/libexpat.a"
